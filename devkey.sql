...
--
-- Host: 127.0.0.1:3307
-- Generation Time: 22-Nov-2019 às 20:54
...
(3, 'Diagrama de Classe', '\r\n                                               aeeeeeeeeeeeeeeeeeeeeeee \r\n\r\n                                                ', 3, '2019-10-02', '2019-10-30', 'fin', 4),
(4, 'Caso de Uso', 'Sistema ASP NET', 5, '2019-09-01', '2019-11-29', 'fin', 5),
(5, 'oio', 'oio', 1, NULL, NULL, 'pen', 1),
(6, 'tarefa', 'tarefa tarefada', 1, NULL, NULL, 'fin', 1),
(7, 'eee', '        eee', 3, NULL, NULL, 'exe', 1),
(8, 'aaaa', '        aaaaa', 4, NULL, NULL, 'pen', 3),
(9, 'aaaa', '        aaaaa', 4, NULL, NULL, 'pen', 5),
(10, 'qqqq', '        qqqq', 1, NULL, NULL, 'pen', 2),
(11, 'oioioi', '        oioioioio', 7, NULL, NULL, 'pen', 4),
(12, 'testeteste', '       hhhhhhhhhhhhhhhhhhhhhhhhhhhhhh ', 8, NULL, NULL, 'exe', 2),
(13, 'aqaqa', '\r\n                            aqaqaq            ', 1, NULL, NULL, 'fin', 3);
...
(10, 'Andressa', 'andilima.oliveira@gmail.com');
